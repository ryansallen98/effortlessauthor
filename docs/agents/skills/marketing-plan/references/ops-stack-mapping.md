...
|---|---|---|
| `product-marketing` | Set up the `docs/agents/context/product-marketing.md` context file (positioning, ICP, voice) | Foundational — run first; every section of the plan references this |

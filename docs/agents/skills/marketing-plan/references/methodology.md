...
```
docs/agents/marketing-plans/{client-slug}/
...
> *"Marketing Plan v1 saved to `docs/agents/marketing-plans/{client-slug}/final_plan.md`. ~X,XXX words across 13 sections. Ready to paste into Notion or share with the team."*

...
node docs/agents/tools/clis/github-prospects.js stargazers vercel/next.js \
...
```bash
node docs/agents/tools/clis/github-prospects.js forks yourorg/yourrepo \
...
```bash
node docs/agents/tools/clis/github-prospects.js watchers tldraw/tldraw \
...
```bash
# Stargazers
node docs/agents/tools/clis/github-prospects.js stargazers <owner/repo> \
  [--limit N] [--enrich] [--with-email] [--with-company] \
  [--with-blog] [--type User|Organization] [--format csv|json]

# Forks
node docs/agents/tools/clis/github-prospects.js forks <owner/repo> [...same flags]

# Watchers (subscribers in API terms)
node docs/agents/tools/clis/github-prospects.js watchers <owner/repo> [...same flags]

# Single user lookup
node docs/agents/tools/clis/github-prospects.js user <username>

# Check rate limit
node docs/agents/tools/clis/github-prospects.js rate-limit
```

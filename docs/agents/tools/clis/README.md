...
```bash
node docs/agents/tools/clis/ahrefs.js backlinks list --target example.com
```
...
ln -sf "$(pwd)/docs/agents/tools/clis/ahrefs.js" ~/.local/bin/ahrefs
ln -sf "$(pwd)/docs/agents/tools/clis/resend.js" ~/.local/bin/resend
...
```bash
export PATH="$PATH:/path/to/repo/docs/agents/tools/clis"
```

...
Keep these docs current when the app changes in ways that affect marketing claims, product positioning, conversion flows, screenshots, pricing, onboarding, integrations, or customer-facing terminology.
